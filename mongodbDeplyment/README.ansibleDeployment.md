...
```ini
[mongodb_servers]
vm1 ansible_host=10.180.22.114
vm2 ansible_host=10.180.22.115
vm3 ansible_host=10.180.22.116
...
```yaml
mongodb_root_user: vault
mongodb_root_password: value

mongodb_server_user: "value"
mongodb_server_password: "value"
```
...
```bash
ssh <username>@10.180.22.114
```

```bash
ssh <username>@10.180.22.115
```

```bash
ssh <username>@10.180.22.116
```
...
```bash
ansible mongodb_servers -i inventory.ini -m ping
```
