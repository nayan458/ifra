...
```ini
[nominatim_servers]
vm1 ansible_host=10.182.0.210

[nominatim_servers:vars]
...
```yaml
nominatim_server_user: "value"
nominatim_server_password: "value"
```
...
```bash
ansible nominatim_servers -i inventory.ini -m ping
```
